...
export function PlayIcon(props: IconProps) {
  return (
    <svg width={props.size ?? 16} height={props.size ?? 16} viewBox="0 0 24 24" fill="currentColor" className={props.className} aria-hidden="true">
...
export function LibraryIcon(props: IconProps) {
  return (
    <Icon {...props}>
      <path d="m16 6 4 14M8 6l-4 14M12 6V4M3 10h18" />
    </Icon>
  );
}
